...
SetMotorsTorqueLimits = _reflection.GeneratedProtocolMessageType('SetMotorsTorqueLimits', (_message.Message,), dict(
...
CmdMeasureNormal = _reflection.GeneratedProtocolMessageType('CmdMeasureNormal', (_message.Message,), dict(
...
ExecuteReposition = _reflection.GeneratedProtocolMessageType('ExecuteReposition', (_message.Message,), dict(
