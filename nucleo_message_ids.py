# FIXME : TODO : define a dictionary of nucleo messages ids or create
#                an automatic generation tool to translate message_types.hpp
#                from the Nucleo project (Carte_GR_SW4STM32) to python
